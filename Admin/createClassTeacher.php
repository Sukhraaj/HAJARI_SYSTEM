                  ...
                  <form method="post">
                   <div class="form-group row mb-3">
                     ...
                     <div class="form-group row mb-3">
                        ...
                        <input type="email" class="form-control"id="txtEmail" onchange="checkEmail()" required name="emailAddress" value="<?php echo $row['emailAddress'];?>" id="txtEmail" >
                        <p id="valid2"></p>
                        </div>
                        <div class="col-xl-6">
                        <label class="form-control-label">Phone No<span class="text-danger ml-2">*</span></label>
                      <input type="number" class="form-control" onchange="check()" name="phoneNo" value="<?php echo $row['phoneNo'];?>" id="exampleInputFirstName" >
...
document.getElementById('valid2').innerHTML="<p style='font-size:10px;font-weight:900;font-family:cursive;color:red;padding-left:70px'>Please provide a valid email address</p>"
email.focus;
return false;
}
else{
  document.getElementById('valid2').innerHTML="<p></p>"
}
}
function check()

    var mobile = document.getElementById('exampleInputFirstName');
